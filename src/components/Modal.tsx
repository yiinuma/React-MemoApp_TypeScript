...
export const Modal: VFC = memo(() => {
  ...
  useEffect(() => {
    if (editIndex !== null) {
      setEditText(memos[editIndex].title);
    }
  }, [editIndex, memos]);
  ...
  const handleSubmit: React.FormEventHandler<HTMLFormElement> = (e) => {
    ...
    //   title: memos[editIndex].title,
    //   category: memos[editIndex].category,
    //   description: memos[editIndex].description,
    //   date: memos[editIndex].date,
    //   mark_div: memos[editIndex].mark_div,
    // };
    upDateMemo(memos[editIndex].id, editText, memos[editIndex].category, memos[editIndex].description, memos[editIndex].date, Boolean(memos[editIndex].mark_div));
